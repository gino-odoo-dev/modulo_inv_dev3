...
class ProductLabelWizard(models.TransientModel):
    ...
    zpl_format = fields.Selection(selection=[('format1', 'Format 1'), ('format2', 'Format 2'), ('format3', 'Format 3')], string="Label Format", default='format1', required=True)
